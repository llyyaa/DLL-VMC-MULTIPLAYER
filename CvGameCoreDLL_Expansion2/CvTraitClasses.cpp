...
int CvTraitEntry::GetInternationalConnectionYieldChange() const
{
	return m_iInternationalConnectionYieldChange;
}
...
bool CvTraitEntry::CacheResults(Database::Results& kResults, CvDatabaseUtility& kUtility)
{
	...
	m_iInternationalConnectionYieldChange = kResults.GetInt("InternationalConnectionYieldChange");
...
void CvPlayerTraits::InitPlayerTraits()
{
	for(int iI = 0; iI < GC.getNumTraitInfos(); iI++)
	{
		if(HasTrait((TraitTypes)iI))
		{
			...
			m_iInternationalConnectionYieldChange = trait->GetInternationalConnectionYieldChange();
...
void CvPlayerTraits::Read(FDataStream& kStream)
{
	...
	kStream >> m_iInternationalConnectionYieldChange;
...
int CvPlayerTraits::GetInternationalConnectionYieldChange() const
{
	return m_iInternationalConnectionYieldChange;
}
